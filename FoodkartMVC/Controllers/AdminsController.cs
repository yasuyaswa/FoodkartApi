    ...
    public class AdminsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Admins != null ? 
                          ...
                          Problem("Entity set 'FoodAppContext.Admins'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("UserId,AdminPass,AdminEmail,AdminMobile")] Admin admin)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("UserId,AdminPass,AdminEmail,AdminMobile")] Admin admin)
        {
            if (id != admin.UserId)
            {
                return NotFound();
